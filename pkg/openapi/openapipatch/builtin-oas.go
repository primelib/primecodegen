...
func FixOAS300Version(doc *libopenapi.DocumentModel[v3.Document], config string) error {
...
func FixOAS301Version(doc *libopenapi.DocumentModel[v3.Document], config string) error {
...
func FixOAS302Version(doc *libopenapi.DocumentModel[v3.Document], config string) error {
...
func FixOAS303Version(doc *libopenapi.DocumentModel[v3.Document], config string) error {
...
func FixOAS304Version(doc *libopenapi.DocumentModel[v3.Document], config string) error {
...
func FixOAS310Version(doc *libopenapi.DocumentModel[v3.Document], config string) error {
...
func FixOAS311Version(doc *libopenapi.DocumentModel[v3.Document], config string) error {
